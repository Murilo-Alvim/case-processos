...
export function Layout() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden">
      {/* Sidebar */}
      <aside className="w-64 shrink-0 border-r border-line bg-panel/60 backdrop-blur-xl flex flex-col">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-14 border-b border-line bg-panel/50 backdrop-blur-xl flex items-center px-6 shrink-0">
